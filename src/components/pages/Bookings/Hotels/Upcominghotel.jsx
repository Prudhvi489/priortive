...
const Upcominghotel = (props) => {
  const { data, dataobj, overallbooking } = props;
  console.log(data, 'upcoming bookin')
          ...
          <Grid container direction={"column"} spacing={2} mb={2}>
            ...
            >
              ...
              >
                ...
                <Grid item>
                  {data.HotelRoomsDetails[0].HotelPassenger[0].Email}
                </Grid>
                <Grid item>
                  and SMS sent to{" "}
                  {data.HotelRoomsDetails[0].HotelPassenger[0].Phoneno}
                </Grid>
              </Grid>
            ...
            <Grid item container xs={12} sx={{ height: "auto!important" }}>
              <Paper
                sx={{
                  borderRadius: "1rem",
              ...
              >
                <Stack spacing={1}>
                  <Grid container alignSelf={"center"}>
                    ...
                    <Grid item md={6}>
                      <span className={mybooking.cancellation_txt}>
                  ...
                  >
                    <Grid item container>
                      <Grid item md={5}>
                        <span className={mybooking.cancellationhead}>
                          {" "}
                          Cancellation Time
                        </span>
                      </Grid>
                    ...
                    {data.HotelRoomsDetails[0].CancellationPolicies.map(
                      (item, index) => {
                        return (
                          <Grid item container>
                            <Grid item md={5}>
                              <span
                                className={mybooking.cancellationdata}
                              >{`Before ${helperFunctions.calculateDateDifference(
                                data.CheckInDate,
                                item.FromDate
                              )}- ${helperFunctions.calculateDateDifference(
                                data.CheckInDate,
                                item.ToDate
                              )} Days`}</span>
                            </Grid>
                            ...
                            <Grid item md={4}>
                              <span className={mybooking.cancellationdata}>{`${item.Currency
            ...
            <Grid item textAlign={"center"} mt={2}>
              <button
                ...
                onClick={() => setCancellationdilog(true)}
              >
                Cancel
              </button>
            </Grid>

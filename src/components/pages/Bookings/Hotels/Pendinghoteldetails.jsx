...
const Pendinghoteldetails = (props) => {
  ...
  let total_adult = guests_details.reduce(
    (sum, item) => sum + item.NoOfAdults,
    0
  );
  let total_child = guests_details.reduce(
  ...
  let data = {
    ...
    HotelRoomsDetails: [
      {
        ...
        CancellationPolicy:
          "Economy Room, 1 Twin Bed#^#100.00% of total amount will be charged, If cancelled between 26-Jul-2023 00:00:00 and 27-Jul-2023 23:59:59.|#!#",
        Inclusion: ["Free WiFi"],
      },
    ],
    AgentRemarks: "",
    ...
    StarRating: 3,
    AddressLine1:
      "8184 Arakashan Road,Paharganj,Near New Delhi Railway Station,New Delhi,IN",
    AddressLine2: "",
    CountryCode: "IN",
    Latitude: "28.6468",
    Longitude: "77.21309",
    ...
    hotel_picture:
      "https://i.travelapi.com/lodging/23000000/22730000/22728200/22728114/9b988241_z.jpg",
  };
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <Queriesdialog
        ...
        close={() => setUserQuerySubmitForm(false)}
        module_type={2}
        ...
        <div className="profileDialog" style={{ borderTopLeftRadius: "1rem", borderTopRightRadius: '1rem' }}>
          ...
          <Grid container direction={"column"} spacing={2}>
            ...
            <Grid
              ...
              sx={{
                background:
                  " linear-gradient(99.8deg, #EBA731 -13.2%, #A36200 109.29%)",
            ...
            >
              <Grid container direction="column" textAlign="center" spacing={3}>
                ...
                <Grid item>
                  <img src={pending_clock} alt="Pending" />
                </Grid>
                <Grid item mb={2}>
                ...
                <Stack p={1} spacing={1}>
                  <Grid container spacing={1}>
                    <Grid
                      item
                      md={3.5}
                      sx={{ padding: "1rem", height: "14rem" }}
                      textAlign={"center"}
                    >
                      <img
                        src={data.hotel_picture}
                        alt="selected_room"
                    ...
                    >
                      ...
                      <Grid item>
                        <Stack direction="row">
                          {Array.from(
                            { length: data?.StarRating },
                            (_, index) => {
                              return <img src={Ratingstar} alt="ratingstar" />;
                            }
                          )}
                        </Stack>
                      </Grid>
                      ...
                      <Grid item>
                        ...
                        >
                          ...
                          <span>{`${total_adult + total_child} ${total_adult + total_child > 1 ? "Guests" : "Guest"
                            }`}</span>
                          <span>{`${guests_details.length} ${guests_details.length > 1 ? "Rooms" : "Room"
                            }`}</span>
                        </Breadcrumbs>
                      </Grid>
                      <Grid item container>
                  ...
                  <Grid item>
                    <span className={room_style.room_name}>
                      {data.HotelRoomsDetails[0].RoomTypeName}
                    </span>
                  </Grid>
                ...
                >
                  <Grid item>
                    <span className="makeFlex">
                      ...
                      &nbsp;
                      <span
                        onClick={() => setUserQuerySubmitForm(true)}
                        className="c-p f-w-700 cursor-p"
                      >
                        Contact Support
                      </span>
                    </span>
                ...
                <Stack spacing={1.5} mt={2}>
                  <Grid item>
                    <Grid container>
                      ...
                      >
                        {`${guests_details.length} ${guests_details.length > 1 ? "Rooms" : "Room"
                          } * ${`${helperFunctions.nights_calc(
                            data.CheckInDate,
                            data.CheckOutDate
                          )} ${helperFunctions.nights_calc(
                      ...
                      <Grid
                        ...
                        className={mybooking.faredata}
                      >
                        {`${data.HotelRoomsDetails[0].CancellationPolicies[0]
                          .Currency
                          } ${helperFunctions.Updated_room_price(
...
export default Pendinghoteldetails;

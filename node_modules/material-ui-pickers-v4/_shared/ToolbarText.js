...
exports.useStyles = core_1.makeStyles(function (theme) {
    ...
    return {
        toolbarTxt: {
            color: core_1.fade(textColor, 0.54),
        },
        toolbarBtnSelected: {
            color: textColor,
        },
...
var ToolbarText = function (_a) {
    ...
    return (React.createElement(core_1.Typography, __assign({ children: label, className: clsx_1.default(classes.toolbarTxt, className, (_b = {},
